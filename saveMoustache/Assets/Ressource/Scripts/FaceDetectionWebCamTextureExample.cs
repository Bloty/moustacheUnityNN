...
namespace OpenCVForUnityExample
{
    ...
    public class FaceDetectionWebCamTextureExample : MonoBehaviour
    {
        ...
        /// <summary>
        /// Recuperer la position du visage et taille ecran
        /// </summary>
        public Vector2 visagePosOrigine;
        public Vector2 visagePosLongLarg;
        ...
        void Update ()
        {
            if (webCamTextureToMatHelper.IsPlaying () && webCamTextureToMatHelper.DidUpdateThisFrame ()) {
                ...
                for (int i = 0; i < rects.Length; i++) {
                    ...
                    //position du visage
                    visagePosOrigine = new Vector2(rects[i].x, rects[i].y);
                    visagePosLongLarg = new Vector2(rects[i].x + rects[i].width, rects[i].y + rects[i].height);
                }
